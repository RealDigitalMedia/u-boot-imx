...
void init_dsa2l_gpio(void) {
	iomux_v3_cfg_t dsa2l_gpio_pads[] = {
		// GPO
		MX6DL_PAD_SD3_CMD__GPIO_7_2,	//LED_BLUE
		MX6DL_PAD_SD3_CLK__GPIO_7_3,	//LED_RED
		MX6DL_PAD_SD3_DAT0__GPIO_7_4,	//WIFI_DISABLE
		MX6DL_PAD_SD3_DAT2__GPIO_7_6,	//PDB_VGA (CH7036 power down)
//		MX6DL_PAD_ENET_TX_D1__GPIO_1_29,	//eMMC_RSTn (Reset eMMC)
		...
		MX6DL_PAD_SD3_DAT3__GPIO_7_7,	//VGA_HPDn (VGA plug in detect)
...
//		MX6DL_PAD_ENET_TX_D0__GPIO_1_30,	//RTC_INTn_R (RTC Interrupt)
		...
		MX6DL_PAD_GPIO_19__GPIO_4_5, 	//RI_PMIC (COM Ring interrupt)
...
// TODO - Add gpio init in here
	// Set multiplexer pin
	mxc_iomux_v3_setup_multiple_pads(dsa2l_gpio_pads, ARRAY_SIZE(dsa2l_gpio_pads));

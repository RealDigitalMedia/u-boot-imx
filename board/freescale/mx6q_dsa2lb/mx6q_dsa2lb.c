...
#define LVDS_MODE IMX_GPIO_NR(1, 8)
...
static void setup_uart(void)
{
	...
	#if defined CONFIG_MX6DL_DSA2LB
	/* UART2 TXD */
...
//		MX6DL_PAD_ENET_TX_D1__GPIO_1_29,	//eMMC_RSTn (Reset eMMC)
		...
		// GPI
		MX6DL_PAD_SD1_CMD__GPIO_1_18,	//MLB_ID0
		MX6DL_PAD_SD1_CLK__GPIO_1_20,	//MLB_ID1
		MX6DL_PAD_SD1_DAT0__GPIO_1_16,	//MLB_ID2
...
//		MX6DL_PAD_ENET_TX_D0__GPIO_1_30,	//RTC_INTn_R (RTC Interrupt)
		...
		MX6DL_PAD_GPIO_17__GPIO_7_12,	//AUDAMP_SHUTDOWNn
...
// TODO - Add gpio init in here
	// Set multiplexer pin
	mxc_iomux_v3_setup_multiple_pads(dsa2lb_gpio_pads, ARRAY_SIZE(dsa2lb_gpio_pads));
	...
	gpio_direction_output(IMX_GPIO_NR(1, 5), 1);	//no SW_SHUTDOWN
